...
protected function setUp(): void
    {
     ...
     require_once __DIR__ . '/../vendor\phpauth\phpauth\Config.php';
     require_once __DIR__ . '/../vendor\phpauth\phpauth\Auth.php';

        self::$dbh = new PDO("mysql:host=localhost;dbname=testwebdb", "root", "");
